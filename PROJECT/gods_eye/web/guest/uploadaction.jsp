        ...
        <%
            ...
            if(isMultipart)
            {
                  ...
                  while(itr.hasNext())
                 {
                     ...
                     else
                     {
                           //f_item=(FileItem)itr.next();            
                            ...
                            if(field_name.equals("photo"))
                            {
                                 ...
                                 String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\guest\\Photo\\";
                                 Random r=new Random();
                    ...
                    //String str1="insert into tb_signup ()";
                    String str1="insert into tbl_users(fname,lname,gender,dob,email,phone,uname,pword)values('"+value[0]+"','"+value[1]+"','"+value[2]+"','"+value[3]+"','"+value[4]+"','"+value[5]+"','"+value[6]+"','"+value[7]+"')";
                    out.println(str1); 
